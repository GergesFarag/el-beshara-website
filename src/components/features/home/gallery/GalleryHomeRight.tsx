...
<div className={`${className} p-4 group space-y-5`}>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
          <div className='w-full p-4 bg-secondary text-secondary-foreground rounded-md'>
            ...
            <p className='text-secondary-foreground/80'>We've produced and recorded over <span className='font-bold text-primary'>500</span>  hours of music for artists</p>
          </div>
          <div className='w-full p-4 bg-secondary text-secondary-foreground rounded-md'>
             <p className='text-base font-bold'>Completed Projects</p>
            <p className='text-secondary-foreground/80'>From singles to full albums, our team has successfully completed over  <span className='font-bold text-primary'>100</span> music projects </p>
          </div>
      </div>
      <Link href="/gallery" className="inline-block bg-primary transition duration-300 cursor-pointer text-primary-foreground  hover:scale-105  rounded-md font-bold  capitalize p-2 px-4">Explore Our Studio Gallery</Link>
    </div>
  )
}
